...
export function ParallaxNewsSection() {
  return (
    <section
      aria-label="最新动态轮播"
      className="flex w-full flex-col items-stretch pt-16 sm:pt-20"
    >
            ...
            return (
              <div className="flex flex-col items-start pt-3">
                ...
                <Link
                  ...
                  className="pointer-events-auto mt-2 inline-flex w-fit items-center gap-1.5 rounded-full bg-white/80 px-3.5 py-1.5 text-[10px] font-medium tracking-wider text-neutral-900 uppercase backdrop-blur-[2px] transition-colors hover:bg-white dark:bg-white/20 dark:text-white dark:hover:bg-white/30 sm:text-xs"
                >
                  查看详情
