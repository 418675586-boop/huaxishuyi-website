...
export default function Aurora(props) {
  ...
  useEffect(() => {
    ...
    const w0 = ctn.offsetWidth || ctn.clientWidth;
    const h0 = ctn.offsetHeight || ctn.clientHeight;
    if (w0 < 2 || h0 < 2) return;
    ...
    try {
      ...
      ctn.classList.add('aurora-ready');
      ...
      return () => {
        ...
        ctn.classList.remove('aurora-ready');
  ...
  return (
    <div ref={ctnDom} className="aurora-container" aria-hidden="true">
