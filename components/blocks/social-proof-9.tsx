...
export function SocialProof9({ embedded = false }: { embedded?: boolean } = {}) {
  const content = (
    <div className="relative flex w-full flex-col items-center justify-center overflow-hidden">
      ...
      <div className="pointer-events-none absolute inset-y-0 left-0 w-1/3 bg-linear-to-r from-white to-transparent dark:from-neutral-950" />
      <div className="pointer-events-none absolute inset-y-0 right-0 w-1/3 bg-linear-to-l from-white to-transparent dark:from-neutral-950" />
    </div>
  );
