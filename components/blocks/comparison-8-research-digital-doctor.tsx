...
const rows: { feature: string; cells: [Cell, Cell] }[] = [
  {
    ...
    cells: [
      {
        status: "yes",
        note: "上传协议AI自动结构化，秒级生成纳入排除标准和随访模板",
      },
      {
        status: "no",
        note: "人工研读协议，手动编写纳入排除标准和随访表单，周期长",
      },
    ],
  },
  {
    ...
    cells: [
      {
        status: "yes",
        note: "数字医生多轮问诊自动匹配Top3项目，效率提升3-5倍",
      },
      {
        status: "no",
        note: "人工逐条比对入排标准，效率极低，招募周期长",
      },
    ],
  },
  {
    ...
    cells: [
      {
        status: "yes",
        note: "AI逐条自动比对（通过/不通过/待确认），决策建议可回溯",
      },
      {
        status: "no",
        note: "人工审核，漏判率高、一致性差，审核依据难追溯",
      },
    ],
  },
  {
    ...
    cells: [
      {
        status: "yes",
        note: "任务日历驱动，AI智能体自动采集，数据完整及时",
      },
      {
        status: "no",
        note: "人工电话+纸质表单，数据不完整、失访率高",
      },
    ],
  },
  {
    ...
    cells: [
      {
        status: "yes",
        note: "病历→对话原文，审核→推理依据，签署→签名轨迹，全链路可回溯",
      },
      {
        status: "no",
        note: "审核依据难回溯，签署过程缺乏电子化轨迹",
      },
    ],
  },
  {
    ...
    cells: [
      {
        status: "yes",
        note: "审核偏好、随访方案自动沉淀为可复用科研资产",
      },
      {
        status: "no",
        note: "经验散落个人手中，无标准化沉淀和复用机制",
      },
    ],
  },
  {
    ...
    cells: [
      {
        status: "yes",
        note: "双端协同，字段标准流程统一，信息无缝衔接",
      },
      {
        status: "no",
        note: "医患两端各自为政，数据标准不统一，信息断层",
      },
    ],
  },
  {
    ...
    cells: [
      {
        status: "yes",
        note: "全流程可溯源可复盘，满足GCP合规性与真实性要求",
      },
      {
        status: "no",
        note: "合规依赖人工保障，风险高、审计难",
      },
    ],
  },
];
...
export default function Comparison8ResearchDigitalDoctor() {
  return (
