...
export default function Contact10() {
  ...
  return (
    <section className="w-full bg-white dark:bg-transparent">
      <div className="px-4 pt-16 pb-16 sm:px-6 sm:pt-20 sm:pb-20 lg:px-8 lg:pt-24 lg:pb-24">
        <div className="mx-auto grid w-full max-w-[1200px] items-start gap-10 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] lg:gap-16">
        <motion.div
          variants={container}
          initial="hidden"
          whileInView="show"
