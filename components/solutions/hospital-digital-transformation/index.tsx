...
const roadmap = [
  {
    ...
    title: "诊断规划",
    description:
      "梳理院内系统与流程断点，明确数智化目标、优先级与投入边界，形成可落地蓝图。",
  },
  {
    step: "02",
    title: "中枢筑基",
    description:
      "建设数据与智能中枢，打通关键系统，沉淀可复用的模型、知识与智能体能力。",
  },
  {
    step: "03",
    title: "场景落地",
    description:
      "优先门急诊与文书减负等高价值场景上线，快速验证效率、质量与体验收益。",
  },
  {
    step: "04",
    title: "全域协同",
    description:
      "扩展住院、运营与患者服务，形成诊前—诊中—诊后闭环，持续迭代优化。",
  },
];
    ...
    <>
      ...
      <main id="main-content" className="relative flex-1 dark:bg-neutral-950">
        ...
        <section className="relative z-[1] bg-[#F8F8F8] px-4 py-[100px] dark:bg-transparent sm:px-6 lg:px-8">
          <div className="mx-auto w-full max-w-[1200px]">
            <div className="mb-10 flex max-w-3xl flex-col gap-3">
              <SectionLabel>落地路径</SectionLabel>
              <h2 className="text-[36px] font-semibold tracking-tight text-neutral-950 dark:text-white">
                四步推进 · 可规划、可验证、可扩展
              </h2>
              <p className="text-[16px] text-neutral-600 dark:text-neutral-400">
                从诊断规划到全域协同，按价值优先级分阶段落地，降低一次性改造风险
              </p>
            </div>
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {roadmap.map((item, index) => (
                <motion.article
                  ...
                  viewport={{ once: true }}
                  transition={{ duration: 0.4, delay: index * 0.05 }}
                  className="relative flex flex-col gap-4 rounded-[20px] bg-white p-6 dark:border dark:border-white/10 dark:bg-white/[0.06] dark:backdrop-blur-xl"
                >
